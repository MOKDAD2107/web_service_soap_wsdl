 ...
 * 
 */
@WebServiceClient(name = "banquews", targetNamespace = "http://ws/", wsdlLocation = "http://localhost:2211/?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:2211/?wsdl");
    ...
    public BanqueService getBanqueServicePort() {
        return super.getPort(new QName("http://ws/", "banque_servicePort"), BanqueService.class);
    }
    ...
    public BanqueService getBanqueServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws/", "banque_servicePort"), BanqueService.class, features);
    }
